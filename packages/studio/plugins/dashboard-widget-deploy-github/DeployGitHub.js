...
const DeployGitHub = () => {
  ...
  const deployStudio = () => {
    ...
    fetch(
      'https://c2je1jc4ub.execute-api.eu-central-1.amazonaws.com/beta/stackbot/add-webhook/e8a05322-ecae-46a6-bb04-ce664dc90f41/purnomoeko/loveforall',
      {
        method: 'POST',
        ...
        <ul className={styles.mid_container}>
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/purnomoeko/loveforall/actions?query=workflow%3A%22Studio+%7C+Build+and+Deploy%22">View Studio Deployment</a>
              </figcaption>
            </figure>
            <button
          ...
          <li className={styles.list}>
            <figure>
              ...
              <figcaption>
                <a href="https://github.com/purnomoeko/loveforall/actions?query=workflow%3A%22Web+%7C+Build+and+Deploy%22">View Web Deployment</a>
              </figcaption>
            </figure>
            <div>
              <button
